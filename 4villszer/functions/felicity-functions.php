...
function felicity_custom_styling() {
	...
	$output .= '.posts-featured-details-wrapper { color: ' . $captions_font_color . '}' . "\n";	
...
function felicity_add_script_function() {
	...
	*/
	...
	wp_enqueue_script('cycle', get_template_directory_uri() . '/js/jquery.cycle.lite.js', array( 'jquery' ),'', false);
	wp_enqueue_script('isotope', get_template_directory_uri() . '/js/jquery.isotope.min.js', array( 'jquery' ),'', false);
	wp_enqueue_script('prettyPhoto', get_template_directory_uri() . '/js/jquery.prettyPhoto.js', array( 'jquery' ),'', false);
	wp_enqueue_script('gmap', 'http://maps.google.com/maps/api/js?sensor=false', array( 'jquery' ),'', false);
	wp_enqueue_script('jquery.ui.map', get_template_directory_uri() . '/js/gmap.js', array( 'jquery' ),'', false);
 ...
 */
function felicity_selectmenu() {
	 	if ( current_user_can('edit_theme_options') ) {
				echo '	<ul id="menu-main-navigation" class="sf-menu sf-js-enabled sf-shadow">
							<li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home">
								<a href="'.get_admin_url().'nav-menus.php">'.__("Select a Menu to appear here in Dashboard->Appearance->Menus ", "felicity").'</a>
							</li>
				...
				echo '	<ul id="menu-main-navigation" class="sf-menu sf-js-enabled sf-shadow">
							<li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home">
								<a href="'.esc_url( get_home_url() ).'">'.__("Home", "felicity").'</a>
							</li>
...
function felicity_options_support() { ?>
	<div id="optionsframework-support">
		<div class="metabox-holder">
			<div class="postbox">
					<div class="inside">
                        <p class="btn"><a class="button green" target="_blank" href="http://www.vpthemes.com/support/"><?php _e('Theme Support','felicity') ?></a> <a class="button orange" target="_blank" href="http://vpthemes.com/preview/Felicity/"><?php _e('View Demo','felicity') ?></a> 
					</div>
			</div>
		</div>
	</div>
