...
get_header(); ?>
	...
	?>
		<div id="main_1">
			<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('main_1')) : else : ?>
			<div class="pre-widget"></div>
			<?php endif; ?>
		</div>
		<div id="main_2">
			<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('main_2')) : else : ?>
			<div class="pre-widget"></div>
			<?php endif; ?>
		</div>
	<?php		
